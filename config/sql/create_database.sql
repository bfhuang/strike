--create database strike;
    ...
    insert into t_strike(person_id, strike_count, star_count) values (1,2,3);
    insert into t_strike(person_id, strike_count, star_count) values (2,1,1);
    insert into t_strike(person_id, strike_count, star_count) values (3,2,2);
    insert into t_strike(person_id, strike_count, star_count) values (4,2,2);
